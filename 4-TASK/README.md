...
```bash
barsukov@compute-vm-2-4-20-hdd-1723564389639:~/kube-prometheus$ cat <<EOF > ~/patch.yml
spec:
  type: NodePort
EOF
barsukov@compute-vm-2-4-20-hdd-1723564389639:~/kube-prometheus$
barsukov@compute-vm-2-4-20-hdd-1723564389639:~/kube-prometheus$
barsukov@compute-vm-2-4-20-hdd-1723564389639:~/kube-prometheus$ kubectl patch svc grafana -n monitoring --patch-file ~/patch.yml
