...
```bash
git clone https://github.com/barsukovNV/Test-application.git
```
...
Загрузим файлы в [Git-репозиторий](https://github.com/barsukovNV/Test-application).
...
```bash
barsukov@compute-vm-2-4-20-hdd-1723564389639:~/mynginx$ sudo docker build -t barsukov/nginx:v1 .
[+] Building 6.4s (7/7) FINISHED                                                                                                             docker:default
 ...
 => => naming to docker.io/barsukov/nginx:v1
```
...
```bash
barsukov@compute-vm-2-4-20-hdd-1723564389639:~/mynginx$ sudo docker images
REPOSITORY          TAG       IMAGE ID       CREATED         SIZE
barsukov/nginx   v1        93d209aa730a   5 minutes ago   43.2MB
```

Запустим docker-контейнер с созданным образом и проверим его  работоспособность:
```bash
barsukov@compute-vm-2-4-20-hdd-1723564389639:~/mynginx$ sudo docker ps
CONTAINER ID   IMAGE                  COMMAND                  CREATED          STATUS          PORTS                               NAMES
7e7d371b7d27   barsukov/nginx:v1   "/docker-entrypoint.…"   15 seconds ago   Up 15 seconds   0.0.0.0:80->80/tcp, :::80->80/tcp   app
barsukov@compute-vm-2-4-20-hdd-1723564389639:~/mynginx$
barsukov@compute-vm-2-4-20-hdd-1723564389639:~/mynginx$
barsukov@compute-vm-2-4-20-hdd-1723564389639:~/mynginx$ curl http://89.169.147.229
<html>
<head>
Hey, Netology
</head>
...
Загрузим созданный образ в реестре [Docker Hub](https://hub.docker.com/layers/barsukovnv/nginx/v1/images/sha256-3058e9f2b17c25ab5f7b6ec42577c3db658890a8f3673b5a9ae092a9aed73fcd?context=repo):
```bash
barsukov@compute-vm-2-4-20-hdd-1723564389639:~/mynginx$ sudo docker push barsukovnv/nginx:v1
The push refers to repository [docker.io/barsukovnv/nginx]
16f5cd97d8ef: Pushed
28d40eb13793: Pushed
2ee64cbdc81d: Pushed
a0bde08c3815: Pushed
